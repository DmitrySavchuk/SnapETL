...
ETL находится в соответствующей директории, а API представлено в виде Flask end-point application, содержащегося в директории End_point_API. База данных содержится в директории SnapETL и используется "с двух сторон". Со стороны пользователя -- через end-point API, со стороны разработчика -- при помощи скрипта ETL.
